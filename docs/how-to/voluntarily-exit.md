...
Use the [`/eth/v1/beacon/pool/voluntary_exits`](https://consensys-incorporated.github.io/teku/#tag/Beacon/operation/getPoolVoluntaryExits) API to check the pending exit queue.
